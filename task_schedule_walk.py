...
class Scheduler:
    ...
    def profile(self):
        ...
        """
        pls = [
            [(1.0, 1.0), (0.38, 0.9295), [(0.06, 0.8559), (0.02, 0.8263)]],
            [(1.0, 1.0), (0.36, 0.9277), [(0.06, 0.8387), (0.02, 0.7981)]],
            [(1.0, 1.0), (0.34, 0.9262), [(0.06, 0.8546), (0.02, 0.8043)]],
            [(1.0, 1.0), (0.44, 0.9389), [(0.08, 0.8581), (0.04, 0.8189)]],
            [(1.0, 1.0), (0.44, 0.9378), [(0.1, 0.8331), (0.04, 0.7764)]],
            [(1.0, 1.0), (0.44, 0.9358), [(0.14, 0.8387), (0.06, 0.7864)]],
            [(1.0, 1.0), (0.46, 0.9399), [(0.14, 0.8465), (0.06, 0.7861)]],
            [(1.0, 1.0), (0.52, 0.9435), [(0.14, 0.8588), (0.06, 0.8003)]],
            [(1.0, 1.0), (0.36, 0.9184), [(0.08, 0.8545), (0.02, 0.8043)]],
            [(1.0, 1.0), (0.34, 0.9146), [(0.06, 0.8446), (0.02, 0.808)]],
            [(1.0, 1.0), (0.38, 0.9207), [(0.06, 0.8333), (0.02, 0.8063)]],
            [(1.0, 1.0), (0.6, 0.954), [(0.18, 0.867), (0.08, 0.8029)]],
            [(1.0, 1.0), (0.46, 0.9422), [(0.14, 0.865), (0.06, 0.8018)]],
            [(1.0, 1.0), (0.46, 0.9454), [(0.1, 0.8666), (0.04, 0.794)]],
            [(1.0, 1.0), (0.42, 0.943), [(0.06, 0.8651), (0.02, 0.7934)]],
            [(1.0, 1.0), (0.46, 0.9485), [(0.08, 0.8749), (0.02, 0.7891)]],
            [(1.0, 1.0), (0.4, 0.9435), [(0.06, 0.8786), (0.02, 0.8285)]],
            [(1.0, 1.0), (0.46, 0.9493), [(0.1, 0.8593), (0.04, 0.816)]],
            [(1.0, 1.0), (0.66, 0.966), [(0.16, 0.8595), (0.06, 0.8071)]],
            [(1.0, 1.0), (0.44, 0.9436), [(0.12, 0.8647), (0.04, 0.809)]],
            [(1.0, 1.0), (0.34, 0.9303), [(0.06, 0.8768), (0.02, 0.851)]],
            [(1.0, 1.0), (0.34, 0.93), [(0.06, 0.8698), (0.02, 0.8381)]],
            [(1.0, 1.0), (0.42, 0.9419), [(0.1, 0.8645), (0.04, 0.8267)]],
            [(1.0, 1.0), (0.34, 0.9327), [(0.06, 0.8514), (0.02, 0.802)]],
            [(1.0, 1.0), (0.4, 0.937), [(0.08, 0.8487), (0.02, 0.7898)]],
            [(1.0, 1.0), (0.42, 0.9417), [(0.08, 0.8675), (0.04, 0.8169)]],
            [(1.0, 1.0), (0.26, 0.924), [(0.04, 0.8523), (0.02, 0.8384)]],
            [(1.0, 1.0), (0.56, 0.9561), [(0.16, 0.8868), (0.04, 0.8173)]],
            [(1.0, 1.0), (0.64, 0.9653), [(0.22, 0.9007), (0.08, 0.8459)]],
            [(1.0, 1.0), (0.5, 0.9519), [(0.14, 0.8949), (0.06, 0.8608)]],
            [(1.0, 1.0), (0.44, 0.9422), [(0.1, 0.8798), (0.04, 0.8542)]],
            [(1.0, 1.0), (0.48, 0.9471), [(0.12, 0.8539), (0.04, 0.8171)]],
            [(1.0, 1.0), (0.3, 0.9337), [(0.04, 0.8098), (0.02, 0.7883)]],
            [(1.0, 1.0), (0.22, 0.924), [(0.04, 0.808), (0.02, 0.7957)]],
            [(1.0, 1.0), (0.24, 0.9281), [(0.02, 0.8313), (0.02, 0.8313)]],
            [(1.0, 1.0), (0.2, 0.9238), [(0.02, 0.8114), (0.02, 0.8114)]],
            [(1.0, 1.0), (0.26, 0.9316), [(0.04, 0.8692), (0.02, 0.852)]],
            [(1.0, 1.0), (0.18, 0.9216), [(0.02, 0.8541), (0.02, 0.8541)]],
            [(1.0, 1.0), (0.1, 0.9094), [(0.02, 0.8891), (0.02, 0.8891)]],
            [(1.0, 1.0), (0.5, 0.9465), [(0.16, 0.885), (0.06, 0.854)]]
        ]

        results = pls[min(self.t, len(pls)-1)]
        self.t += 1
    ...
    def p1(self, pre_tp_length, pre_number_of_tasks):
        ...
        f1, feq, x1, x2, self.th, self.resolution, _, _ = solver_long_tail(self.v, self.quality_req,
                                                                           #round(self.quality_queue + predict_quality,
                                                                           #      1),
                                                                           self.quality_queue,
                                                                           int(self.window),
                                                                           self.server_paras,
    ...
    def batch_processing(self, start, end, scheduled, assignments, resolution, th):
        ...
        while time.time() - self.init_tp < self.init_tp:  # Abr 3 Fix self.init_tp
            time.sleep(0.2)
